...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    final Clip clipBehavior = widget.clipBehavior ?? CustomexpansionTileTheme.clipBehavior ?? Clip.none;

    return Container(
      clipBehavior: clipBehavior,
      decoration: ShapeDecoration(
        color: _backgroundColor.value ?? CustomexpansionTileTheme.backgroundColor ?? Colors.transparent,
  ...
  void didChangeDependencies() {
    ...
    _headerColorTween
      ..begin = widget.collapsedTextColor ?? CustomexpansionTileTheme.collapsedTextColor ?? theme.textTheme.titleMedium!.color
